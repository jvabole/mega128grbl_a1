...
#define cpu_map_h
...
#ifdef CPU_MAP_ATMEGA128A // (NOT Arduino Uno) Officially supported by Grbl.
  ...
  #define STEP_DDR        DDRE // DDRD old
  #define STEP_PORT       PORTE
  #define X_STEP_BIT      2  // ATMEGA128 Pin 4
  #define Y_STEP_BIT      3  // ATMEGA128 Pin 5
  #define Z_STEP_BIT      4  // ATMEGA128 Pin 6
  #define STEP_MASK       ((1<<X_STEP_BIT)|(1<<Y_STEP_BIT)|(1<<Z_STEP_BIT)) // All step bits

  // Define step direction output pins. NOTE: All direction pins must be on the same port.
  #define DIRECTION_DDR     DDRB // DDRD old
  #define DIRECTION_PORT    PORTB
  #define X_DIRECTION_BIT   0  // ATMEGA128 Pin 10
  #define Y_DIRECTION_BIT   1  // ATMEGA128 Pin 11
  #define Z_DIRECTION_BIT   2  // ATMEGA128 Pin 12
  #define DIRECTION_MASK    ((1<<X_DIRECTION_BIT)|(1<<Y_DIRECTION_BIT)|(1<<Z_DIRECTION_BIT)) // All direction bits

  // Define stepper driver enable/disable output pin.
  #define STEPPERS_DISABLE_DDR    DDRG
  #define STEPPERS_DISABLE_PORT   PORTG
  #define STEPPERS_DISABLE_BIT    3  // ATMEGA128 Pin 18
  ...
  #define X_LIMIT_BIT      5  // ATMEGA128 Pin 7
  #define Y_LIMIT_BIT      6  // ATMEGA128 Pin 8
  //***#ifdef VARIABLE_SPINDLE // Z Limit pin and spindle enabled swapped to access hardware PWM on Pin 11.
    #define Z_LIMIT_BIT	   7 // ATMEGA128 Pin 9
  //***#else
  ...
  #endif
  #define LIMIT_INT        INT0 //***IE0  // Pin change interrupt enable pin
...
//  #define LIMIT_PCMSK      PCMSK0 // Pin change interrupt register
  ...
  #define CONTROL_RESET_BIT         0  // ATMEGA128 Pin 25
  #define CONTROL_FEED_HOLD_BIT     1  // ATMEGA128 Pin 26
  #define CONTROL_CYCLE_START_BIT   2  // ATMEGA128 Pin 27
  #define CONTROL_SAFETY_DOOR_BIT   3  // ATMEGA128 Pin 28
  #define CONTROL_INT       INT1 //***IE1 //PCIE1***  // Pin change interrupt enable pin
  #define CONTROL_INT_vect  INT1_vect //P***CINT1_vect
  //***#define CONTROL_PCMSK     PCMSK1 // Pin change interrupt register
  #define CONTROL_MASK      ((1<<CONTROL_RESET_BIT)|(1<<CONTROL_FEED_HOLD_BIT)|(1<<CONTROL_CYCLE_START_BIT)|(1<<CONTROL_SAFETY_DOOR_BIT))
  #define CONTROL_INVERT_MASK   CONTROL_MASK // May be re-defined to only invert certain control pins.

  // Define probe switch input pin.
  #define PROBE_DDR       DDRG
  #define PROBE_PIN       PING
  #define PROBE_PORT      PORTG
  #define PROBE_BIT       4  // ATMEGA128 Pin 19
  #define PROBE_MASK      (1<<PROBE_BIT)
    ...
    #define COOLANT_FLOOD_BIT   3  // ATMEGA128 Pin 13
    #define COOLANT_MIST_DDR   DDRB
    #define COOLANT_MIST_PORT  PORTB
    #define COOLANT_MIST_BIT   4  // ATMEGA128 Pin 14
    ...
    // Z Limit pin and spindle PWM/enable pin swapped to access hardware PWM on Pin 11.
        ...
        #define SPINDLE_ENABLE_BIT    5  // ATMEGA128 Pin 15 (NOTE: D13 can't be pulled-high input due to LED.)
      #else
        #define SPINDLE_ENABLE_BIT    6  // Uno Digital Pin 16
      #endif
    #else
      #define SPINDLE_ENABLE_BIT    6  // ATMEGA128 Pin 16
    #endif
    #ifndef USE_SPINDLE_DIR_AS_ENABLE_PIN
      #define SPINDLE_DIRECTION_DDR   DDRB
      #define SPINDLE_DIRECTION_PORT  PORTB
      #define SPINDLE_DIRECTION_BIT   5  // ATMEGA128 Pin 15 (NOTE: D13 can't be pulled-high input due to LED.)
    #endif
    ...
    #define SPINDLE_TCCR_REGISTER    TCCR2
//***    #define SPINDLE_TCCRB_REGISTER    TCCR2B
    #define SPINDLE_OCR_REGISTER      OCR2
    #define SPINDLE_COMB_BIT          COM21 //COM2A1***

    // Prescaled, 8-bit Fast PWM mode.
    #define SPINDLE_TCCR_INIT_MASK   ((1<<WGM20) | (1<<WGM21 | 1<<CS21 | 1<<CS20))  // Configures fast PWM mode.
	// 1/64 prescaler -> 0.98kHz (J-tech laser)
...
//***    #define SPINDLE_TCCRB_INIT_MASK      (1<<CS22)               // 1/64 prescaler -> 0.98kHz (J-tech laser)
    ...
    #define SPINDLE_PWM_BIT   7 //3***    // ATMEGA128 Pin 17
